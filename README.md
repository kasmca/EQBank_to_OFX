...
Supports both EQ Bank Card and EQ Bank Savings Account CSV exports. The format is auto-detected on file load.
Features
...
Transactions load automatically with all rows selected by default
...
The finished executable will be at C:\EQConverter\dist\EQBank_OFX_Converter.exe
